...
class SurroundingsSection extends declared(Section) {
        ...
        new SurroundingsElement({
          ...
          content: () => {
            ...
            return (<div class="content">
              ...
              <div><span class="magnifier-icon"><svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="search" class="svg-inline--fa fa-search fa-w-16" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="currentColor" d="M505 442.7L405.3 343c-4.5-4.5-10.6-7-17-7H372c27.6-35.3 44-79.7 44-128C416 93.1 322.9 0 208 0S0 93.1 0 208s93.1 208 208 208c48.3 0 92.7-16.4 128-44v16.3c0 6.4 2.5 12.5 7 17l99.7 99.7c9.4 9.4 24.6 9.4 33.9 0l28.3-28.3c9.4-9.4 9.4-24.6.1-34zM208 336c-70.7 0-128-57.2-128-128 0-70.7 57.2-128 128-128 70.7 0 128 57.2 128 128 0 70.7-57.2 128-128 128z"></path></svg></span><a href="javascript: void(0)" onclick={() => this.appState.view.goTo(new Camera({"position":{"spatialReference":{"wkid":102100},"x":19217769.63426079,"y":-5392993.09345789,"z":61.78855136036873},"heading":141.6144031333414,"tilt":68.38175187634266}))}>Christchurch Cathedral</a></div>
  ...
  camera = new Camera({"position":{"spatialReference":{"wkid":102100},"x":19216988.6661089,"y":-5392695.704602988,"z":405.48013736959547},"heading":104.45309520805158,"tilt":62.494322278867756});
